...
const webpackBaseConfig = {
	entry:{
		app:["eventsource-polyfill","babel-polyfill",path.resolve(__dirname,'../src/entry/index.js')]
	},
	devServer:{
        contentBase:'.',
        compress: true,
	...
	plugins:[
        ...
        new AntdScssThemePlugin(resolve("src/theme/theme.scss"))
    ],
    output:{
	...
	resolve:{
	        extensions: ['.js', '.json','.jsx'],//不配置.less,当jsx文件名和less的文件名相同时导入会出现问题
	        alias: {
		      '@': resolve('src'),
